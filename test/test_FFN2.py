...
split_vector0 = SplitVectorExplorer.explore_legal_split_vector(
    update=update,
    tasks=[up_input, up_weight, relu_input],
    memory_coord=shared_memory_coord,
    overflow=st_env.does_mlp_memory_overflow
)

split_vector1 = SplitVectorExplorer.explore_legal_split_vector(
    update=update,
    tasks=[relu_input],
    memory_coord=shared_memory_coord,
    overflow=st_env.does_pointwise_memory_overflow
)

split_vector2 = SplitVectorExplorer.explore_legal_split_vector(
    update=update,
    tasks=[down_input, down_weight, output],
    memory_coord=shared_memory_coord,
    overflow=st_env.does_mlp_memory_overflow
)
