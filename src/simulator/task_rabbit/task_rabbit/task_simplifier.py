...
from src.simulator.resource_simulator.st_env import STEnv, STMatrix
from src.simulator.task_rabbit.task_graph_parser import TaskGraphParser
from src.simulator.task_rabbit.task_model import *
from src.simulator.task_rabbit.task_model import TaskBlockType
    ...
    def simplify_task(st_env: STEnv):
        ...
        for node_id in node_keys:
            ...
            if TaskBlockType.is_storage_task(node.task_type) and \
                ...
                task_graph.add_edge(node_id, id_output)
