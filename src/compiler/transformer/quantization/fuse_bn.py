...
from src.compiler.transformer.quantization.base import QConv2d, QLinear
from src.compiler.transformer.quantization.snn import QConv2d as SQConv2d
from src.compiler.transformer.quantization.snn import QLinear as SQLinear
