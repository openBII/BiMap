...
public:
    Implementation(const YAML::Node &config, std::string ifce_name, std::string name, std::string desc, Implementation *parent) : m_config(config),
                                                                                                                                  m_ifce_name(ifce_name), m_name(name), m_desc(desc), m_id(config["id"].as<std::string>("_default_id")),
                                                                                                                                  m_parent(parent), m_params(config){};

    Implementation(const YAML::Node &config, std::string ifce_name, std::string name, std::string desc, std::string id, Implementation *parent) : m_config(config),
                                                                                                                                                  m_ifce_name(ifce_name), m_name(name), m_desc(desc), m_id(id),
                                                                                                                                                  m_parent(parent), m_params(config){};

    Implementation(std::string id, Implementation *parent) : m_id(id), m_parent(parent){};
